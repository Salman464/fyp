...
<div id="main-wrapper">
	<header class="topbar">
		<nav class="navbar top-navbar navbar-expand-md navbar-dark">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php echo site_url('Complinant/index'); ?>">
					<!-- Logo icon -->
					<b>
			...
			<div class="navbar-collapse">
				...
				<ul class="navbar-nav my-lg-0">
					<li class="nav-item dropdown u-pro">
						<a class="nav-link dropdown-toggle waves-effect waves-dark" data-toggle="dropdown"
						   aria-haspopup="true" aria-expanded="false"><span
									class="hidden-md-down"><?php echo $this->session->userdata('name'); ?> &nbsp;<i
										class="fa fa-angle-down" aria-hidden="true"></i></span> </a>
						<div class="dropdown-menu dropdown-menu-right animated flipInY">
							<a href="<?php echo site_url('Complinant/profile'); ?>" class="dropdown-item"><i
	...
	<aside class="left-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Complinant/index'); ?>" aria-expanded="false"><i
								class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a></li>
				<div class="dropdown-divider"></div>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Complinant/register_complaint'); ?>" aria-expanded="false"><i
								class="icon-note"></i><span class="hide-menu">Complaint</span></a></li>
				<div class="dropdown-divider"></div>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Complinant/complaint_history'); ?>" aria-expanded="false"><i
								class="icon-clock"></i><span class="hide-menu">Complaint History</span></a></li>
				<div class="dropdown-divider"></div>
			</ul>
		</nav>
	</aside>
