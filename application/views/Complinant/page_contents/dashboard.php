<div class="page-wrapper">
	<div class="container-fluid">
		...
		<a href="<?php echo site_url('Complinant/complaint_history'); ?>">
				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex no-block align-items-center">
							<div>
								<h3><i class="icon-doc"></i></h3>
								<p class="text-muted">Open Complaints</p>
							</div>
							<div class="ml-auto">
								<h2 class="counter text-primary"><?php echo $openComplaints; ?></h2>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex no-block align-items-center">
							<div>
								<h3><i class="icon-doc"></i></h3>
								<p class="text-muted">Solved Complaints</p>
							</div>
							<div class="ml-auto">
