	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="POST" action="<?php echo site_url('Complinant/regComplaint'); ?>">
					<div class="form-body">
					...
					<div class="form-actions text-right">
						<button type="submit" class="btn btn-success"> <i class="fa fa-check" style="margin-right: 10px;"></i>Submit</button>
					</div>
				</form>
			</div>
		</div>
