<div class="page-wrapper printArea">
	<div class="container-fluid">
		<div class="row page-titles">
			<a href="<?php echo site_url('StoreMan/availableInventory') ?>" class="btn btn-secondary"><i class="fa fa-arrow-left"></i></a>
									...
									<table id="allItemsTable" class="table table-bordered table-striped">
										...
										<?php foreach ($history as $row){ ?>
											<tr>
                                                ...
                                                <td><a class="btn btn-info btn-sm" href="<?php echo site_url('StoreMan/usedInComplaint/'.$row['complaint_id']); ?>"><i class="fa fa-edit"></i>Complaint<?php echo ' #'.$row['complaint_id']; ?></a></td>	
