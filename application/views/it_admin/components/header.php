...
<div id="main-wrapper">
	<header class="topbar">
		<nav class="navbar top-navbar navbar-expand-md navbar-dark">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php echo site_url('ITAdmin/index'); ?>">
					<!-- Logo icon -->
					<b>
				...
				<ul class="navbar-nav my-lg-0">
					<li class="nav-item dropdown u-pro">
						...
						<div class="dropdown-menu dropdown-menu-right animated flipInY">
							<a href="<?php echo site_url('ITAdmin/profile'); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
	...
	<aside class="left-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('ITAdmin/index'); ?>" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a></li>
				<div class="dropdown-divider"></div>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('ITAdmin/complaints'); ?>" aria-expanded="false"><i class="icon-doc"></i><span class="hide-menu">Complaints</span></a></li>
				<div class="dropdown-divider"></div>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('ITAdmin/technicians'); ?>" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Technicians</span></a></li>
				<div class="dropdown-divider"></div>
			</ul>
		</nav>
	</aside>
