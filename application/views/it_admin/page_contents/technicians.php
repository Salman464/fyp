			...
			<div class="card-body">
				<div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					<div class="modal-dialog">
						<form action="<?php echo site_url('ITAdmin/addTechnician'); ?>" method="post" class="form-horizontal form-material">
								...
								<div class="modal-body">
									<div class="form-group">
										<div class="col-md-12 m-b-20">
											<input type="number" pattern="\d*" onKeyPress="if(this.value.length==15) return false;" name="id" class="form-control" placeholder="Type ID" required>
										</div>
										<div class="col-md-12 m-b-20">
											<input type="text" name="dept_name" class="form-control" value="IT" readonly required>
										</div>
										<div class="col-md-12 m-b-20">
				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<?php foreach ($tech as $d) { ?>
						<tr>
							...
							<td>
								<form action="<?php echo site_url('ITAdmin/view_technician_performance/' . $d->technician_id); ?>" method="get">
									...
									<button class="btn btn-info d-none d-lg-block m-l-15" type="submit"><i class="fas fa-check-square" style="margin-right: 5px;"></i> View Details
									</button>
								</form>
							</td>
						</tr>
