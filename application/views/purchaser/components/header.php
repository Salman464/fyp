...
<div id="main-wrapper">
	...
	<header class="topbar">
		<nav class="navbar top-navbar navbar-expand-md navbar-dark">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php echo site_url('Purchaser/index'); ?>">
					<!-- Logo icon -->
					<b>
				...
				<ul class="navbar-nav my-lg-0">
					<li class="nav-item dropdown u-pro">
						...
						<div class="dropdown-menu dropdown-menu-right animated flipInY">
							<a href="<?php echo site_url('Purchaser/profile'); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
	...
	<aside class="left-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Purchaser/index'); ?>" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a></li>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Purchaser/complaint_history'); ?>" aria-expanded="false"><i class="icon-clock"></i><span class="hide-menu">Complaint History</span></a></li>
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('Purchaser/requested_products'); ?>" aria-expanded="false"><i class="icon-note"></i><span class="hide-menu">Products Requests</span></a></li>
			</ul>
		</nav>
	</aside>
