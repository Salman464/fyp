								...
								<div class="table-responsive">
									<table id="allComplaintsTable" class="table table-bordered table-striped">
										...
										<?php foreach ($complaints as $row) { ?>
											<tr>
												<td>
													<b><a href="<?php echo site_url('Purchaser/view_complaint/' . $row->complaint_id); ?>"><?php echo $row->complaint_id; ?></a></b>
												</td>
												...
												<td>
													<a href="<?php echo site_url('Purchaser/view_complaint/' . $row->complaint_id); ?>"><span
