...
<head>
	...
	<link href="<?php echo base_url(); ?>assets/admin/node_modules/footable/css/footable.bootstrap.min.css"
		  rel="stylesheet">
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url(); ?>assets/admin/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css">
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url(); ?>assets/admin/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
...
<div id="main-wrapper">
	<header class="topbar">
		<nav class="navbar top-navbar navbar-expand-md navbar-dark">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php echo site_url('AssetKeeper/index'); ?>">
					<!-- Logo icon -->
					<b>
						...
						<img src="<?php echo base_url(); ?>assets/admin/images/logo-icon.png" alt="homepage"
							 class="dark-logo"/>
						<!-- Light Logo icon -->
						<img src="<?php echo base_url(); ?>assets/admin/images/logo-light-icon.png" alt="homepage"
							 class="light-logo" />
					</b>
					<!--End Logo icon -->
					<!-- Logo text -->
			...
			<div class="navbar-collapse">
				...
				<ul class="navbar-nav my-lg-0">
					<li class="nav-item dropdown u-pro">
						<a class="nav-link dropdown-toggle waves-effect waves-dark" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-power-off"></i>
						   <span class="hidden-md-down"><?php echo $this->session->userdata('name'); ?> &nbsp; <i class="fa fa-angle-down" aria-hidden="true"></i></span> </a>
						<div class="dropdown-menu dropdown-menu-right animated flipInY">
							<a href="<?php echo site_url('AssetKeeper/profile'); ?>" class="dropdown-item"><i
										class="ti-user"></i> My Profile</a>
							<div class="dropdown-divider"></div>
							<a href="<?php echo site_url('Login/logout'); ?>" class="dropdown-item"><i
	...
	<aside class="left-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				<div class="dropdown-divider"></div>
				<li><a href="<?php echo site_url('AssetKeeper/index'); ?>" aria-expanded="false"><i
								class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a></li>
				<div class="dropdown-divider"></div>
				<div class="dropdown-divider"></div>
				<?php if($this->session->userdata('logged_in') === TRUE && $this->session->userdata('user_type') === '1'): ?>
					<li><a href="<?php echo site_url('AssetKeeper/backToAdmin'); ?>" aria-expanded="false"><i
									class="fa fa-undo"></i><span class="hide-menu">Back to Admin</span></a></li>
					<div class="dropdown-divider"></div>
				<?php endif; ?>
				<?php if($this->session->userdata('logged_in') === TRUE && $this->session->userdata('user_type') === '4'): ?>
					<li><a href="<?php echo site_url('AssetKeeper/backToStore'); ?>" aria-expanded="false"><i
									class="fa fa-undo"></i><span class="hide-menu">Back to Admin</span></a></li>
					<div class="dropdown-divider"></div>
				<?php endif; ?>
			</ul>
