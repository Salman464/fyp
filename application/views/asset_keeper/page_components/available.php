	...
	<div class="container-fluid">
		...
		<div id="add-Item" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog">
				<form role="form" action="<?php echo site_url('AssetKeeper/addNewItem'); ?>" method="post"  class="form-horizontal form-material">
		...
		<div id="update-quantity" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog">
				<form role="form" action="<?php echo site_url('AssetKeeper/updateQuantity/'); ?>" method="get" class="form-horizontal form-material">
					<div class="modal-content">
						<div class="modal-header">
		...
		<div class="modal fade" id="delConfirmModal" tabindex="-1" role="dialog" aria-labelledby="Delete item" aria-hidden="true">
			<div class="modal-dialog" role="document">
				...
				<div class="modal-header">
					...
					<form role="form" action="<?php echo site_url('AssetKeeper/deleteEntire/'); ?>" method="post" class="form-horizontal form-material">
						<div class="modal-body">	
								<div class="col-md-12 m-b-20">
							...
							<table id="restoreItemTable" class="table table-bordered table-striped" data-toggle="table" data-search="true" data-show-columns="true">
								...
								<?php foreach ($restoreable as $row){ ?>
									<tr>
										...
										<td><a class="btn btn-success btn-sm" href="<?php echo site_url('AssetKeeper/restoreDeleted/'.$row['id']); ?>"><i class="fa fa-trash-undo" style="margin-right: 3px;"></i>Restore</a></td>
									</tr>
								<?php } ?>
								</tbody>
							</table>
						...
						<div class="tab-pane active" id="all" role="tabpanel">
							<div class="p-20">
								<div class="table-responsive">
									<table id="inventoryi" class="table table-bordered table-striped" data-toggle="table" data-search="true" data-show-columns="true">
										<thead>
										<tr>
										<tr>
											<th>Item ID#</th>
										...
										<?php foreach (array_reverse($items) as $row){ ?>
											<tr>
													...
													<td>
														<div class="btn-group">
															<a type="button" class="btn btn-info" href="<?php echo site_url('AssetKeeper/deleteItem/'.$row['id']); ?>">Utilize item</a>
															...
															<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																...
																<a class="dropdown-item" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="Details" aria-describedby="tooltip392481" href="<?php echo site_url('AssetKeeper/itemDetailsWithHistory/'.$row['id']); ?>" style="margin:3px;"><i class="fa fa-info" style="margin-right: 5px;"></i>More info</a>
																<div class="dropdown-divider"></div>
																<a class="dropdown-item" href="<?php echo site_url('AssetKeeper/editItem/'.$row['id']); ?>"><i class="fa fa-edit" style="margin-right: 5px;"></i> Edit</a>
