<div class="page-wrapper">
	<div class="container-fluid">
		...
		<div class="card">
            ...
            <form action="<?php echo site_url('AssetKeeper/copyToIssued/'.$item['id']); ?>" method="post">
				...
				<div class="form-actions text-right">
                    ...
                    <a href="<?php echo site_url('AssetKeeper/availableInventory') ?>" class="btn btn-secondary">Cancel</a>
				</div>
			</div>
